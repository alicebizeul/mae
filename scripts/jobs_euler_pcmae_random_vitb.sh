...
cd /cluster/home/callen/projects/mae_branches/mae_lossA
...
DATASETs=(pcmae_tiny_pcsampling pcmae_cifar10_pcsampling )
# DATASETs=(pcmae_clevr_pcsampling)
MODEL="vit-b"
for DATASET in "${DATASETs[@]}"
do
RUN_TAG=""$DATASET"_model_"$MODEL"_lossA"
NAME="/cluster/home/callen/projects/mae_branches/mae_lossA/output_log/$RUN_TAG"
