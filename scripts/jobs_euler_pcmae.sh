...
JOB="/cluster/home/abizeul/miniconda3/envs/mae/bin/python main.py user=abizeul_euler trainer.max_epochs=1000 data.patch_size=4 experiment=$DATASET masking.pc_ratio=$MASK run_tag=$RUN_TAG"
