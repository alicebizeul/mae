...
categories = ["CIFAR10","TinyIN","Derma","Blood","Path"]
...
fig.update_layout(
    ...
    legend=dict(
            ...
            y=0.9,  # Position legend inside plot
            bgcolor='rgba(255,255,255,1.0)'  # Transparent legend background
        ),
    paper_bgcolor='rgba(0, 0, 0, 0)',  # Transparent paper background
    plot_bgcolor='rgba(0, 0, 0, 0)',  # Transparent plot background
    margin=dict(l=10, r=10, t=20, b=10),  # Adjust margins to fit titles
...
# fig.show() 
fig.write_image("bar_plot_5_subplots_closer_bars.pdf", format='png', scale=2,width=500,height=300)
fig.write_image("bar_plot_5_subplots_closer_bars.png", format='png', scale=2,width=500,height=300)
