...
# Tiny dataset values
tiny_pmae = [19.1, 18.5, 18.0, 17.4]
tiny_mae = [17.7, 17.1, 16.3, 15.5]

# CIFAR dataset values
cifar_pmae = [51.8, 53.4, 54.3, 55.1]
cifar_mae = [49.8, 50.4, 50.5, 50.7]

# Blood dataset values
blood_pmae = [89.0, 89.5, 90.5, 91.0]
blood_mae = [74.7, 75.2, 77.9, 77.6]

# Blood dataset values
derma_pmae = [75.3,76.7,77.2,77.4]
derma_mae = [70.8,72.3,73.5,73.5]

# Path
path_pmae = [94.5,94.4,94.7,94.7]
